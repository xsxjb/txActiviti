...
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REF,USER_REPO_REF,USER_REPO_ID,SCOPE_ID) VALUES(1,'root','1',1,1,'1',1,'1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REF,USER_REPO_REF,USER_REPO_ID,SCOPE_ID) VALUES(2,'admin','1',1,2,'1',1,'1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REF,USER_REPO_REF,USER_REPO_ID,SCOPE_ID) VALUES(3,'cuitianyu','1',1,3,'1',3,'1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REF,USER_REPO_REF,USER_REPO_ID,SCOPE_ID) VALUES(4,'jiangbo','1',1,4,'1',3,'1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REF,USER_REPO_REF,USER_REPO_ID,SCOPE_ID) VALUES(5,'yanlei','1',1,5,'1',3,'1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REF,USER_REPO_REF,USER_REPO_ID,SCOPE_ID) VALUES(6,'zhanyingda','1',1,6,'1',3,'1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REF,USER_REPO_REF,USER_REPO_ID,SCOPE_ID) VALUES(7,'linzhao','1',1,7,'1',3,'1');
...
INSERT INTO AUTH_PERM(ID,CODE,NAME,PERM_TYPE_ID,SCOPE_ID) VALUES(71,'org-company-list','公司',7,'1');
INSERT INTO AUTH_PERM(ID,CODE,NAME,PERM_TYPE_ID,SCOPE_ID) VALUES(72,'org-department-list','部门',7,'1');
...
INSERT INTO AUTH_PERM_ROLE_DEF(PERM_ID,ROLE_DEF_ID) VALUES(72,2);
...
--company
INSERT INTO AUTH_ACCESS(ID,TYPE,VALUE,PERM_ID,PRIORITY,SCOPE_ID) VALUES(13,'URL','/group/org-company-list*',71,13,'1');
INSERT INTO AUTH_ACCESS(ID,TYPE,VALUE,PERM_ID,PRIORITY,SCOPE_ID) VALUES(14,'URL','/group/org-department-list*',72,14,'1');
