...
INSERT INTO IB_MENU(ID,MENUNAME,MENULEVEL,MENUURL,MENUIFRAME,MENUORDER,PARENTID) VALUES('mTwo31','我的任务','2','#','URL','21','mOne3');
...
INSERT INTO IB_MENU(ID,MENUNAME,MENULEVEL,MENUURL,MENUIFRAME,MENUORDER,PARENTID) VALUES('mThree421','审批权限流程','3','/permission/permission-list.do?flowType=0&flowId=d2d4beec-cfcd-428a-9916-5bf1f10c7147','URL','421','mTwo42');
