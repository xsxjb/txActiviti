...
INSERT INTO IB_MENU(ID,MENUNAME,MENULEVEL,MENUURL,MENUIFRAME,MENUORDER,PARENTID) VALUES('crmmanageTwo1','商务管理','2','#','URL','1','crmmanageOne');
...
INSERT INTO IB_MENU(ID,MENUNAME,MENULEVEL,MENUURL,MENUIFRAME,MENUORDER,PARENTID) VALUES('crmmanageThree2','供应商管理','3','/supplier/supplier-list.do','URL','2','crmmanageTwo1');
