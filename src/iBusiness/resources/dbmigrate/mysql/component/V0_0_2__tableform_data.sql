...
/* ====== 审批权限流程子表 =====  */
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION_S.REMARK','审批权限流程子表.备注','REMARK','IB_PERMISSION_S','1','','','1','1','2','',2);
