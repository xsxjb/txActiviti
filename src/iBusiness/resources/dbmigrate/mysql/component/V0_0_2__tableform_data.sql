...
/* ============================= 表单对应字段管理表 =============================  */
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','testForm','IB_TEST.ID','UUID主键','ID','IB_TEST','','','','1','1','2','',1);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','testForm','IB_TEST.NAME','姓名','NAME','IB_TEST','','','','1','1','1','',2);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','testForm','IB_TEST.REMARK','备注','REMARK','IB_TEST','','','','1','1','2','',3);
/* ====== 审批权限流程表 =====  */
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION.ID','审批权限流程表.UUID主键','ID','IB_PERMISSION','','','','1','1','2','',1);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION.EXECUTIONID','审批权限流程表.流程执行实例ID','EXECUTIONID','IB_PERMISSION','','','','1','1','2','',2);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION.CREATEDATEBPM','审批权限流程表.流程创建时间','CREATEDATEBPM','IB_PERMISSION','','','','1','1','2','',3);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION.ASSIGNEEUSER','审批权限流程表.负责人','ASSIGNEEUSER','IB_PERMISSION','','','','1','1','2','',4);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION.NODENAME','审批权限流程表.流程节点名','NODENAME','IB_PERMISSION','','','','1','1','2','',5);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION.TASKTITLE','审批权限流程表.流程实例标题','TASKTITLE','IB_PERMISSION','','','','1','1','2','',6);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION.REMARK','备注','REMARK','IB_PERMISSION','','','','1','1','2','',7);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION.DONEFLAG','审批权限流程表.流程结束标记','DONEFLAG','IB_PERMISSION','','','','1','1','2','',8);
/* ====== 审批权限流程子表 =====  */
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION_S.ID','审批权限流程子表.UUID主键','ID','IB_PERMISSION_S','','','','1','1','2','',1);
INSERT INTO ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN,TABLENAME,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCDEFAULT,COLUMNNO) VALUES('test','permissionForm','IB_PERMISSION_S.PARENTID','审批权限流程子表.主表UUID','PARENTID','IB_PERMISSION_S','','','','1','1','2','',2);
