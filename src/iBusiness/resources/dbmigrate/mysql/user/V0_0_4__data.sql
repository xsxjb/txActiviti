...
INSERT INTO USER_BASE(ID,USERNAME,PASSWORD,DISPLAY_NAME,STATUS,REF,USER_REPO_ID,SCOPE_ID,JOB_INFO_ID,CSS,ROLE_DEF_ID) VALUES(4,'jiangbo','a1ccdbc7f295e0aeda5dc4e0f2677ea3','姜博',1,4,1,'1',2,'Cerulean',3);
...
INSERT INTO USER_BASE(ID,USERNAME,PASSWORD,DISPLAY_NAME,STATUS,REF,USER_REPO_ID,SCOPE_ID,JOB_INFO_ID,CSS,ROLE_DEF_ID) VALUES(6,'zhanyingda','a1ccdbc7f295e0aeda5dc4e0f2677ea3','詹应答',1,6,1,'1',2,'Cerulean',3);
INSERT INTO USER_BASE(ID,USERNAME,PASSWORD,DISPLAY_NAME,STATUS,REF,USER_REPO_ID,SCOPE_ID,JOB_INFO_ID,CSS,ROLE_DEF_ID) VALUES(7,'lvdeyang','a1ccdbc7f295e0aeda5dc4e0f2677ea3','吕德阳',1,7,1,'1',2,'Cerulean',3);
