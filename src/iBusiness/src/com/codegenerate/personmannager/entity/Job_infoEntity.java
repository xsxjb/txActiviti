...
public class Job_infoEntity implements java.io.Serializable {
	...
	/**salarystandard*/
	private java.lang.String salarystandard;
	/**enterdate*/
	 ...
	 */
	@Column(name ="POSTTITLE",nullable=true,length=10)
	 ...
	 */
	@Column(name ="ADMINLEVEL",nullable=true,length=10)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  salarystandard
	 */
	@Column(name ="SALARYSTANDARD",nullable=true,length=10)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  salarystandard
	 */
	public void setSalarystandard(java.lang.String salarystandard){
