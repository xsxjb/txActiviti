...
import com.codegenerate.projectmanage.entity.Materials_typeEntity;
import com.codegenerate.projectmanage.service.Materials_typeService;
...
public class Materials_typeController {
   ...
   /**
    ...
    public String list(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, Model model) {
        ...
        // 返回JSP
        return "codegenerate/projectmanage/materials_type-list.jsp";
    }
    ...
    public String input(@RequestParam(value = "id", required = false) String id, Model model) {
        ...
        Map<String, com.ibusiness.component.form.entity.ConfFormTableColumn> formTableColumnMap = CommonBusiness
                .getInstance().getFormTableColumnMap("IB_MATERIALS_TYPE", "materialsType");
        net.sf.json.JSONObject jsonObj = net.sf.json.JSONObject.fromObject(formTableColumnMap.get("RPARENTID")
                .getConfSelectInfo());
        String sql = jsonObj.getString("sql");
        List<Map<String, Object>> list = ApplicationContextHelper.getBean(com.ibusiness.common.service.CommonBaseService.class).getJdbcTemplate().queryForList(sql);
        List<ConfSelectItem> rparentidItems = new java.util.ArrayList<ConfSelectItem>();
        for (Map<String, Object> mapBean : list) {
            ...
            rparentidItems.add(confSelectItem);
        }
                model.addAttribute("rparentidItems", rparentidItems);
        return "codegenerate/projectmanage/materials_type-input.jsp";
    }
