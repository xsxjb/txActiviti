...
<html>
  ...
  <head>
    ...
    <title>经营预算年度计划增补、变更流程表列表</title>
  ...
  <body>
	...
	<div class="panel panel-default col-md-10 ">
        ...
        <ul class="nav nav-tabs">
		  <li class="${flowType =='0' ? 'active' : ''} "><a href="${scopePrefix}/annualchangeplan/annualchangeplan-list.do?flowId=${flowId}&flowType=0" >待办</a></li>
		  <li class="${flowType =='1' ? 'active' : ''} "><a href="${scopePrefix}/annualchangeplan/annualchangeplan-list.do?flowId=${flowId}&flowType=1" >已办</a></li>
		</ul>
							      ...
							      <tr>
								    ...
								    <tbody>
								      ...
								      <tr>
								        ...
								        <td>
								            <a target="_blank"  href="annualchangeplan-graph.do?flowId=${flowId}&id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="图"/></a>
								        </td>
								      </tr>
								      </c:forEach>
								    </tbody>
