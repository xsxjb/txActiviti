  ...
  <body>
	...
	<div class="panel panel-default col-lg-10 ">
        ...
        <ul class="nav nav-tabs">
		  <li class="${flowType =='0' ? 'active' : ''} "><a href="${ctx}/annualmaterialplan/annualmaterialplan-list.do?flowId=${flowId}&flowType=0" >待办</a></li>
		  <li class="${flowType =='1' ? 'active' : ''} "><a href="${ctx}/annualmaterialplan/annualmaterialplan-list.do?flowId=${flowId}&flowType=1" >已办</a></li>
		</ul>
		<div id="tabContent" class="tab-content">
			...
			<c:if test="${flowType == '0'}">
			    ...
			    <div class="panel panel-default">
				    <!-- 查询条件 -->
			        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">年度经营预算材料计划汇总表流程查询</h4></div>
			        <div class="panel-body">
				          <div id="search" class="content content-inner">
							  <form name="bpmFlowForm" method="post" action="annualmaterialplan-list.do?flowId=${flowId}&flowType=0" class="form-inline">
			        ...
			        <div class="panel-body">
					    <div class="pull-left">
						    <button class="btn btn-primary btn-sm a-insert" onclick="location.href='annualmaterialplan-input.do?flowId=${flowId}'"><span class="glyphicon glyphicon-tasks"></span>新建</button>
				    ...
				    <div class="content">
						<form id="gridForm" name="gridForm" method='post' action="annualmaterialplan-remove.do" class="m-form-blank">
							      ...
							      <tr>
								    ...
								    <tbody>
								      ...
								      <tr class="${status.index%2==1? 'active':''}">
								        ...
								        <td>
								          <a href="annualmaterialplan-input.do?flowId=${flowId}&id=${item.id}" class="a-update"><span class="glyphicon glyphicon-pencil"></span></a>
								        </td>
								        ...
								        <td>
								            <a target="_blank"  href="annualmaterialplan-graph.do?flowId=${flowId}&id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="图"/></a>
								        </td>
								      </tr>
								      </c:forEach>
								    </tbody>
			  ...
			  <!-- ========================== 已办流程信息 =================================================== -->
			   ...
			   <div class="panel panel-default">
				    <!-- 查询条件 -->
			        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">已办年度经营预算材料计划汇总表流程查询</h4></div>
			        <div class="panel-body">
				          <div id="search" class="content content-inner">
							  <form name="bpmFlowForm" method="post" action="annualmaterialplan-list.do" class="form-inline">
							    <div class="form-group">
