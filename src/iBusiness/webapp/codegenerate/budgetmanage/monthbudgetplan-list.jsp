  ...
  <body>
	...
	<div class="panel panel-default col-md-10 ">
        ...
        <ul class="nav nav-tabs">
		  <li class="${flowType =='0' ? 'active' : ''} "><a href="${scopePrefix}/monthbudgetplan/monthbudgetplan-list.do?flowId=${flowId}&flowType=0" >待办</a></li>
		  <li class="${flowType =='1' ? 'active' : ''} "><a href="${scopePrefix}/monthbudgetplan/monthbudgetplan-list.do?flowId=${flowId}&flowType=1" >已办</a></li>
		</ul>
		<div id="tabContent" class="tab-content">
		    <!-- ========================== 待办流程信息 =================================================== -->
			    ...
			    <div id=bpmBase class="tab-pane fade  ${flowType == '0'? 'active in' : ''}">
				    <!-- 查询条件 -->
			        <div class="panel-heading"><h4 class="panel-title">经营预算月计划表流程查询</h4></div>
			        ...
			        <div class="panel-body">
					    <div class="pull-left">
						    <button class="btn btn-default btn-sm a-insert" onclick="location.href='monthbudgetplan-input.do?flowId=${flowId}'">新建</button>
							      ...
							      <tr>
								    ...
								    <tbody>
								      ...
								      <tr>
								        ...
								        <td>
								          <a href="monthbudgetplan-input.do?flowId=${flowId}&id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
								        </td>
