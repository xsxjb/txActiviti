  ...
  <body>
	...
	<div class="panel panel-default col-lg-10 ">
        ...
        <ul class="nav nav-tabs">
		  <li class="${flowType =='0' ? 'active' : ''} "><a href="${ctx}/monthbudgetreal/monthbudgetreal-list.do?flowId=${flowId}&flowType=0" >待办</a></li>
		  <li class="${flowType =='1' ? 'active' : ''} "><a href="${ctx}/monthbudgetreal/monthbudgetreal-list.do?flowId=${flowId}&flowType=1" >已办</a></li>
		</ul>
		<div id="tabContent" class="tab-content">
			...
			<c:if test="${flowType == '0'}">
			    ...
			    <div class="panel panel-default">
				    <!-- 查询条件 -->
			        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">经营预算月计划执行表流程查询</h4></div>
			        ...
			        <div class="panel-body">
					    <div class="pull-left">
						    <button class="btn btn-primary btn-sm a-insert" onclick="location.href='monthbudgetreal-input.do?flowId=${flowId}'"><span class="glyphicon glyphicon-tasks"></span>新建</button>
							      ...
							      <tr>
								    ...
								    <tbody>
								      ...
								      <tr class="${status.index%2==1? 'active':''}">
								        ...
								        <td>
								          <a href="monthbudgetreal-input.do?flowId=${flowId}&id=${item.id}" class="a-update"><span class="glyphicon glyphicon-pencil"></span></a>
								        </td>
			  ...
			  <!-- ========================== 已办流程信息 =================================================== -->
			   ...
			   <div class="panel panel-default">
				    <!-- 查询条件 -->
			        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">已办经营预算月计划执行表流程查询</h4></div>
			        <div class="panel-body">
				          <div id="search" class="content content-inner">
