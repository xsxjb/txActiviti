...
<html>
  ...
  <head>
    ...
    <script type="text/javascript">
		var config = {
			...
			gridFormId: 'gridForm',
	        exportUrl: 'contract_manage-export.do'
		};
  ...
  <body>
	...
	<!-- 查询条件 -->
	   ...
	   <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">合同管理列表</h4></div>
       <div class="panel-body">
		    <div class="pull-left">
			    <button class="btn btn-primary btn-sm a-insert" href="contract_manage-input.do" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-tasks"></span>新建</button>
	   ...
	   <div class="content">
			<form id="gridForm" name="gridForm" method='post' action="contract_manage-remove.do" class="m-form-blank">
