    ...
    <div class="panel panel-default col-lg-10">
        ...
        <div class="panel-body">
			<div class="content content-inner">
					<form id="subForm" method="post" action="device_out_s-save.do?parentid=${parentid}&flowId=${flowId}" class="form-horizontal">
					  <c:if test="${model != null}">
					      <input id="code_id" type="hidden" name="id" value="${model.id}">
					  </c:if>
                               <div class="form-group">
                              <label class="control-label col-lg-2" for="code-deviceno">设备编号:</label>
                              <div class="col-lg-3">  <c:if test="${nodeColumsMap.deviceno.fcEdit=='1'}">    <input id="code-deviceno" type="text" name="deviceno" value="${model.deviceno}" class="text required" >  </c:if>  <c:if test="${nodeColumsMap.deviceno.fcEdit!='1'}">    <label>${model.deviceno}</label>    <input type="hidden" name="deviceno" value="${model.deviceno}">  </c:if></div>
