  ...
  <body>
    ...
    <div class="panel panel-default col-lg-12"> 
        ...
        <div class="panel-body">
                <form id="cgForm" method="post" action="warehouse_devices-save.do" class="form-horizontal">
                  ...
                  <div class="form-group">
	                  <div class="col-lg-10 col-lg-offset-2">
	                      ...
	                      <button type="button" onclick="location.href='warehouse_devices-list.do'" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-log-out"></span> 关闭</button>
	                  </div>
                  </div>
                </form>
        </div>
