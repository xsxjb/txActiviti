...
<html>
  ...
  <head>
    ...
    <script type="text/javascript">
		var config = {
			...
			gridFormId: 'gridForm',
	        exportUrl: 'person_job_info-export.do'
		};
  ...
  <body>
	...
	<!-- 查询条件 -->
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">查询</h4></div>
          <div class="panel-body">
	          <div id="search" class="content content-inner">
				  <form name="cgForm" method="post" action="person_job_info-list.do" class="form-inline">
	   ...
	   <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">人员就职表列表</h4></div>
       <div class="panel-body">
		    <div class="pull-left">
			    <button class="btn btn-primary btn-sm a-insert" href="person_job_info-input.do" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-tasks"></span>新建</button>
	   ...
	   <div class="content">
			<form id="gridForm" name="gridForm" method='post' action="person_job_info-remove.do" class="m-form-blank">
