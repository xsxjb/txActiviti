...
<html>
  ...
  <head>
    ...
    <script type="text/javascript">
		var config = {
			...
			gridFormId: 'gridForm',
	        exportUrl: 'person_remove-export.do'
		};
  ...
  <body>
	...
	<!-- 查询条件 -->
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">查询</h4></div>
          <div class="panel-body">
	          <div id="search" class="content content-inner">
				  <form name="cgForm" method="post" action="person_remove-list.do" class="form-inline">
	   ...
	   <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">复职登记表列表</h4></div>
       <div class="panel-body">
		    <div class="pull-left">
			    <button class="btn btn-primary btn-sm a-insert" href="person_remove-input.do" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-tasks"></span>新建</button>
	   ...
	   <div class="content">
			<form id="gridForm" name="gridForm" method='post' action="person_remove-remove.do" class="m-form-blank">
			  <table id="codeGrid" class="table table-hover table-striped">
			      <thead>
				      <tr>
				        <th width="30" class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
					                <th class="sorting">人事档案ID(姓名)</th>
					                <th class="sorting">原属部门</th>
					                <th class="sorting">原属职务</th>
					                <th class="sorting">复职日期</th>
					    ...
					    <tbody>
					      ...
					      <tr class="${status.index%2==1? 'active':''}">
					        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.id}"></td>
						            ...
						            <td>${item.remark}</td>
					        <td>
					          <a href="person_remove-input.do?id=${item.id}" class="a-update" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-pencil"></span></a>
					        </td>
					      </tr>
					      </c:forEach>
					    </tbody>
