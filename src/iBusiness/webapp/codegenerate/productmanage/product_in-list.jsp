  ...
  <body>
	...
	<div class="panel panel-default col-md-10 ">
        ...
        <ul class="nav nav-tabs">
		  <li class="${flowType =='0' ? 'active' : ''} "><a href="${scopePrefix}/product_in/product_in-list.do?flowId=${flowId}&flowType=0" >待办</a></li>
		  <li class="${flowType =='1' ? 'active' : ''} "><a href="${scopePrefix}/product_in/product_in-list.do?flowId=${flowId}&flowType=1" >已办</a></li>
		</ul>
		<div id="tabContent" class="tab-content">
		    <!-- ========================== 待办流程信息 =================================================== -->
			    ...
			    <div id=bpmBase class="tab-pane fade  ${flowType == '0'? 'active in' : ''}">
			        ...
			        <div class="panel-body">
					    <div class="pull-left">
						    <button class="btn btn-default btn-sm a-insert" onclick="location.href='product_in-input.do?flowId=${flowId}'">新建</button>
							      ...
							      <tr>
								    ...
								    <tbody>
								      ...
								      <tr>
								        ...
								        <td>
								          <a href="product_in-input.do?flowId=${flowId}&id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
								        </td>
