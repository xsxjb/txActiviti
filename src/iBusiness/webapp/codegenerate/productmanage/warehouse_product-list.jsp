...
<html>
  ...
  <body>
	...
	<!-- 查询条件 -->
	          ...
	          <div id="search" class="content content-inner">
				  <form name="cgForm" method="post" action="warehouse_product-list.do" class="form-inline">
				    <div class="form-group">
				                <label for="code_table_productname">产品库存管理表.产品名:</label>
       ...
       <div class="panel-body">
		    <div class="pull-left">
			    <button class="btn btn-default btn-sm a-insert" onclick="location.href='warehouse_product-input.do'">新建</button>
				      ...
				      <tr>
					    ...
					    <tbody>
					      ...
					      <tr>
					        ...
					        <td>
					          <a href="warehouse_product-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
					        </td>
					      </tr>
					      </c:forEach>
					    </tbody>
