...
<html>
  ...
  <body>
	...
	<!-- 查询条件 -->
        <div class="panel-heading"><h4 class="panel-title">查询</h4></div>
          <div class="panel-body">
	          <div id="search" class="content content-inner">
				  <form name="cgForm" method="post" action="producttype-list.do" class="form-inline">
				    <div class="form-group">
				                <label for="code_table_typename">产成品分类名称:</label>
	   ...
	   <div class="content">
			<form id="gridForm" name="gridForm" method='post' action="producttype-remove.do" class="m-form-blank">
