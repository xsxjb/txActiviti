...
<html>
  ...
  <body>
    ...
    <div class="panel panel-default col-lg-12"> 
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">产品质监任务表编辑</h4></div>
                ...
                <form id="cgForm" method="post" action="project_quality-save.do" class="form-horizontal">
                  ...
                  <div class="form-group">
	                  <div class="col-lg-10 col-lg-offset-2">
	                      ...
	                      <button type="button" onclick="location.href='project_quality-list.do'" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-log-out"></span> 关闭</button>
	                  </div>
                  </div>
                </form>
        </div>
