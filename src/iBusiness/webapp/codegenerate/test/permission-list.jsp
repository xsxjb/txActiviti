		...
		<div id="tabContent" class="tab-content">
		    <!-- ========================== 待办流程信息 =================================================== -->
			    ...
			    <div id=bpmBase class="tab-pane fade  ${flowType == '0'? 'active in' : ''}">
			        ...
			        <div class="panel-body">
					    <div class="pull-left">
						    <button class="btn btn-default btn-sm a-insert" onclick="location.href='permission-input.do?flowId=${flowId}'">新建</button>
							      ...
							      <tr>
								    ...
								    <tbody>
								      ...
								      <tr>
								        ...
								        <td>
								          <a href="permission-input.do?flowId=${flowId}&id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
								        </td>
