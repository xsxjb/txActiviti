...
<html>
  ...
  <body>
    ...
    <div class="panel panel-default col-lg-12"> 
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">测试555编辑</h4></div>
        <div class="panel-body">
                <form id="cgForm" method="post" action="test5-save.do" class="form-horizontal">
                  ...
                  <div class="form-group">
	                  <div class="col-lg-10 col-lg-offset-2">
	                      ...
	                      <button type="button" onclick="location.href='test5-list.do'" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-log-out"></span> 关闭</button>
	                  </div>
                  </div>
                </form>
        </div>
