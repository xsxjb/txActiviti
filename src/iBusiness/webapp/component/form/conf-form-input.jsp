  ...
  <body>
	...
	<div class="panel panel-default span10"> 
        ...
        <ul class="nav nav-tabs">
		  ...
		  <li class="${tabType == 'formLabel' ? 'active' : ''}"><a href="${scopePrefix}/form/conf-formLabel-input.do?packageName=${packageName}&formId=${formId}">控件类型</a></li>
		</ul>
	        	      ...
	        	      <table class="table table-hover table-bordered" id=“tableModelGrid” >
							...
							<c:forEach items="${formTableColumns}" var="item">
							    <tr>
									...
									<td>${item.tableColumn}</td>
									<td>
							          <a href="conf-table-column-list.do?tableName=${item.formColumn}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
							        </td>
							    </tr>
							  </c:forEach>
							</tbody>
