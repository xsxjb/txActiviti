...
<body onload="init();">
	<div id="toolCanvas"  style="position: relative; height: 40px; width:1080px; border: 1px solid;">
		...
		<div class="tool"  title="任务节点" id="TaskNode">
			<img height="30px" width="30px" name="taskNode" id="taskNodeImg" src="../plugin/ibusiness/flowchart/img/tasknode.png" />
		</div>
		<div class="tool"  title="结束" id="EndNode">
			<img height="30px" width="30px" name="endNode" id="endNodeImg" src="../plugin/ibusiness/flowchart/img/endnode.png" />
		</div>
		<div class="tool"  title="线" id="Pipeline">
			<img height="30px" width="30px" name="line" id="lineImg" src="../plugin/ibusiness/flowchart/img/waterflow.png" />
		</div>
		<div class="tool"  title="选择" id="select">
			<img height="30px" width="30px" name="select" id="selectImg" src="../plugin/ibusiness/flowchart/img/select.jpg" />
		</div>
		<!--  -->
		...
		<!--  -->
		<div class="tool"  title="查询" id="search"><img height="30px" width="30px" src="../plugin/ibusiness/flowchart/img/query.gif" /></div>
		<div class="tool"  title="保存" id="save"><img height="30px" width="30px" src="../plugin/ibusiness/flowchart/img/save.gif" /></div>
		<div class="tool"  title="删除所有" id="delete"><img height="30px" width="30px"  src="../plugin/ibusiness/flowchart/img/delete.png" /></div>
