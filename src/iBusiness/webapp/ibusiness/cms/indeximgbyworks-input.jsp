		...
		<div class="panel-body">
			<form id="cgForm" method="post" action="indeximgbyworks-save.do" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
					    <img id="code_img_name" height="200" width="150" src="${ctx}/ibresources/imgworks/${model.imgurl}" />
						...
						if( window.confirm("您确认要上传吗?") == true ){
							...
							$form.ajaxSubmit({
								...
								success: function (data) {
									$('#code_table_imgurl').attr('value',data);
									$('#code_table_imgurl_text').attr('value',data);
									$('#code_img_name').attr('src','${ctx}/ibresources/imgworks/'+data);
								},
								error: function () {
									alert('请求数据出错了!');
								}
