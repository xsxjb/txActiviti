	...
	<div class="panel panel-default col-lg-10">
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">表单列表</h4></div>
          <div class="panel-body">
			    <div class="pull-left">
			        <p>
					    <button class="btn btn-primary btn-sm a-insert" onclick="location.href='conf-form-input.do?packageName=${packageName}&isBpmForm=2'">新建</button>
			  ...
			  <table id="formGrid" class="table table-hover table-striped">
			    ...
			    <tbody>
			      ...
			      <tr>
			        ...
			        <td>
			          <a href="conf-form-input.do?formId=${item.id}&packageName=${packageName}&isBpmForm=2" class="a-update"><span class="glyphicon glyphicon-pencil"></span></a>
			        </td>
			      </tr>
			      </c:forEach>
			    </tbody>
