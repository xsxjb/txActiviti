...
<html>
		...
		var config = {
		    ...
		    params: {
		        'filter_LIKES_id': '${param.filter_LIKES_id}'
		                ,'filter_LIKES_typename': '${param.filter_LIKES_typename}'
		    },
			selectedItemClass: 'selectedItem',
			gridFormId: 'gridForm',
	        exportUrl: 'doctype-export.do'
		};
  ...
  <body>
	...
	<!-- 查询条件 -->
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">查询</h4></div>
          <div class="panel-body">
	          <div id="search" class="content content-inner">
				  <form name="cgForm" method="post" action="doctype-list.do" class="form-inline">
				    <div class="form-group">
				                <label for="code_table_typename">类型名:</label>
	   ...
	   <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">文件类型列表</h4></div>
       <div class="panel-body">
		    <div class="pull-left">
			    <button class="btn btn-primary btn-sm a-insert" href="doctype-input.do" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-tasks"></span>新建</button>
	   ...
	   <div class="content">
			<form id="gridForm" name="gridForm" method='post' action="doctype-remove.do" class="m-form-blank">
					    ...
					    <tbody>
					      ...
					      <tr class="${status.index%2==1? 'active':''}">
					        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.id}"></td>
						            ...
						            <td>${item.typename}</td>
					        <td>
					          <a href="doctype-input.do?id=${item.id}" class="a-update" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-pencil"></span></a>
					        </td>
					      </tr>
					      </c:forEach>
					    </tbody>
