...
OpenLayers.Map = OpenLayers.Class({
    ...
    */
    initialize: function (div, options) {
        ...
        this.theme = OpenLayers._getScriptLocation() +
                             '../../map/css/theme/default/style.css';
    ...
    */
    ...
    //zj 2011-10-25 region -----------

    zoomToMinExtent: function (options) {
        //restricted is true by default
        var restricted = (options) ? options.restricted : true;
        var maxExtent = this.getMaxExtent({
            'restricted': restricted
        });
        this.zoomToExtent(minExtent);  //�޸ĺ�
    },
    ...
    */
    ...
    setMyBoundZoomCenter: function () {
//        var _nowzoom = this.zoom;

//        if (_nowzoom == 0 && _nowzoom > _oldzoom) {
//            //ȫ������
//            setMyGlobalCenter(this, _nowzoom);
//        }
//        else if (_nowzoom == 8 && _nowzoom > _oldzoom) {
//            //�й�����
//            setMyChinaCenter(this, _nowzoom);

//        } else if (_nowzoom == 10 && _nowzoom > _oldzoom) {
//            //��������
//            setMyLiaoNingCenter(this, _nowzoom);
//        }
//        else {
//            //�����϶�
//            if (_oldzoom < 8 && _nowzoom > _oldzoom && _nowzoom > 8) {
//                //�й�����
//                setMyChinaCenter(this, _nowzoom);

//            } else if (_oldzoom < 10 && _nowzoom > _oldzoom && _nowzoom > 10) {
//                //��������
//                setMyLiaoNingCenter(this, _nowzoom);
...
//            //�����϶�
//            //  else if (_oldzoom >= 9 && _nowzoom < _oldzoom && _nowzoom < 9) {
//            //      //ȫ��
//            //      setMyGlobalCenter(this, _nowzoom);

//            //  } 

//            //   else if (_oldzoom >= 11 && _nowzoom < _oldzoom && _nowzoom < 11) {
//            //      //�й�����
//            //      setMyChinaCenter(this, _nowzoom);
//            //  }
//        }
...
// function setMyGlobalCenter(map1, _nowzoom) {
//         var _lonlat = new OpenLayers.LonLat(0, 0);
//         var _ll = _lonlat.transform(new OpenLayers.Projection("EPSG:4326"), new OpenLayers.Projection("EPSG:900913"));
//         map1.setCenter(_ll, _nowzoom);
//         zoomChangePrompt(_nowzoom, "ȫ��", " ȫ������ !");
//    }

// function setMyChinaCenter(map1,_nowzoom) {
//         var _lonlat = new OpenLayers.LonLat(104.45801, 34.72807);
//         var _ll = _lonlat.transform(new OpenLayers.Projection("EPSG:4326"), new OpenLayers.Projection("EPSG:900913"));
//         map1.setCenter(_ll, _nowzoom);
//         zoomChangePrompt(_nowzoom, "�й�", " �й����� !");
//    }

// function setMyLiaoNingCenter(map1, _nowzoom) {
//         var _lonlat = new OpenLayers.LonLat(123.42041, 41.80817);
//         var _ll = _lonlat.transform(new OpenLayers.Projection("EPSG:4326"), new OpenLayers.Projection("EPSG:900913"));
//         map1.setCenter(_ll, _nowzoom);
//         zoomChangePrompt(_nowzoom, "����", " �������� !");
//    }
