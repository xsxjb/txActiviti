...
function DiscValve( id,x,y ){
	...
	this.win = "/XMCP/genericPlcControlStationStatusAction!queryDiscValue.action";
	...
	this.init = function( json ){
		...
		if( this.direction == "horizontal" ){
			this.bark.src = "../../../js/icons/df-h.png";
		}else{
			this.bark.src = "../../../js/icons/df-v.png";
		}
	...
	this.clickView = function( mouseX,mouseY ){
		...
		if( this.isPop == 1 && this.model == 'control' ){
			...
			$("#controlPage").css({top:(canvas.height-200)/2+50 ,left:(canvas.width-300)/2});
			$("#controlPage").css({width:300 ,height:200});
