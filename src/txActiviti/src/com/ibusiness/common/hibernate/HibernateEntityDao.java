...
public class HibernateEntityDao<T> extends HibernatePagingDao {
     ...
     */
    @Transactional(readOnly = true)
    public IbPage pagedQuery(int pageNo, int pageSize, Criterion... criterions) {
     ...
     */
    @Transactional(readOnly = true)
    public IbPage pagedQuery(int pageNo, int pageSize, String orderBy, boolean isAsc, Criterion... criterions) {
        logger.debug("start");
     ...
     * @return List
     */
    public List<T> findBy(String propertyName, Object propertyValue, IbMatchType matchType) {
     ...
     * @return List
     */
    public List<T> find(List<IbPropertyFilter> propertyFilters) {
     ...
     * @return page
     */
    public IbPage pagedQuery(int pageNo, int pageSize, List<IbPropertyFilter> propertyFilters) {
     ...
     * @return page
     */
    public IbPage pagedQuery(IbPage page, List<IbPropertyFilter> propertyFilters) {
        return pagedQuery(this.entityClass, page, HibernateUtils.buildCriterion(propertyFilters));
    }

    // ~ ======================================================================
    // hql
    public IbPage pagedQuery(String hql, IbPage page, List<IbPropertyFilter> propertyFilters) {
        return pagedQuery(hql, page.getPageNo(), page.getPageSize(), propertyFilters);
    }

    public IbPage pagedQuery(String hql, int pageNo, int pageSize, List<IbPropertyFilter> propertyFilters) {
        StringBuilder buff = new StringBuilder(hql);
        Map<String, Object> map = new HashMap<String, Object>();

        for (IbPropertyFilter propertyFilter : propertyFilters) {
