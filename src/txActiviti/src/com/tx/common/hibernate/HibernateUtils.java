...
public class HibernateUtils {
    ...
    public static Criterion buildCriterion(String propertyName,
            Object propertyValue, IbMatchType matchType) {
     ...
     * @return Criterion[]
     */
    public static Criterion[] buildCriterion(List<IbPropertyFilter> filters) {
        List<Criterion> criterionList = new ArrayList<Criterion>();

        for (IbPropertyFilter filter : filters) {
            // 只有一个属性需要比较的情况.
    ...
    public static void buildQuery(StringBuilder buff,
            IbPropertyFilter propertyFilter) {
