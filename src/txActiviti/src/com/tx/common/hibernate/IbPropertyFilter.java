 ...
 * @author Lingo
 */
public class IbPropertyFilter {
    /** or seperator. */
    public static final String OR_SEPARATOR = "_OR_";

    /** match type. */
    private IbMatchType IbMatchType;
     ...
     *            String
     */
    public IbPropertyFilter(final String filterName, final String value) {
        ...
        try {
            IbMatchType = Enum.valueOf(IbMatchType.class, matchTypeCode);
        ...
        try {
            propertyClass = Enum.valueOf(IbPropertyType.class, propertyTypeCode)
                    .getValue();
        } catch (RuntimeException e) {
            throw new IllegalArgumentException("filter名称" + filterName
                    + "没有按规则编写,无法得到属性值类型.", e);
        ...
        propertyNames = StringUtils.splitByWholeSeparator(propertyNameStr,
                IbPropertyFilter.OR_SEPARATOR);

        if (IbMatchType == IbMatchType.IN) {
     ...
     * @return list
     */
    public static List<IbPropertyFilter> buildFromHttpRequest(
    ...
    public static List<IbPropertyFilter> buildFromMap(
    ...
    public static List<IbPropertyFilter> build(Map<String, Object> filterParamMap) {
        List<IbPropertyFilter> filterList = new ArrayList<IbPropertyFilter>();
        ...
        for (Map.Entry<String, Object> entry : filterParamMap.entrySet()) {
            ...
            if (StringUtils.isNotBlank(value)) {
                IbPropertyFilter filter = new IbPropertyFilter(filterName, value);
    ...
    /** @return IbMatchType. */
    public IbMatchType getMatchType() {
        return IbMatchType;
    }
