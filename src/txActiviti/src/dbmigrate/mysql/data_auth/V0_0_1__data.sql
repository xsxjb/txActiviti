...
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REFERENCE,USER_REPO_REF,SCOPE_ID) VALUES(1,'lingo','1',1,1,'1','1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REFERENCE,USER_REPO_REF,SCOPE_ID) VALUES(2,'vivian','1',1,2,'1','1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REFERENCE,USER_REPO_REF,SCOPE_ID) VALUES(3,'steven','1',1,3,'1','1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REFERENCE,USER_REPO_REF,SCOPE_ID) VALUES(4,'king','1',1,4,'1','1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REFERENCE,USER_REPO_REF,SCOPE_ID) VALUES(5,'john','1',1,5,'1','1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REFERENCE,USER_REPO_REF,SCOPE_ID) VALUES(6,'william','1',1,6,'1','1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REFERENCE,USER_REPO_REF,SCOPE_ID) VALUES(7,'adam','1',1,7,'1','1');
INSERT INTO AUTH_USER_STATUS(ID,USERNAME,PASSWORD,STATUS,REFERENCE,USER_REPO_REF,SCOPE_ID) VALUES(8,'admin','1',1,1,'1','1');
