  ...
  <body>
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <region:region-permission permission="cal-info:create">
		  <button class="btn btn-small a-insert" onclick="location.href='cal-info-input.do'">新建</button>
		  </region:region-permission>
		  <region:region-permission permission="cal-info:delete">
  ...
  <table id="cal-infoGrid" class="m-table table-hover">
    <thead>
      <tr>
        ...
        <th class="sorting" name="name"><spring:message code="cal-info.cal-info.list.name" text="名称"/></th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.endTime}</td>
        <td>
          <a href="cal-info-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
