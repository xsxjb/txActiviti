    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgSearch" class="content content-inner">
		  ...
		  <form name="orgForm" method="post" action="job-level-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='job-level-input.do'">新建</button>
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title">职级列表</h4>
		</header>
		<div class="content">

<form id="orgGridForm" name="orgGridForm" method='post' action="job-level-remove.do" class="m-form-blank">
