    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgSearch" class="content content-inner">
		  ...
		  <form name="orgForm" method="post" action="job-user-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='job-user-input.do'">新建</button>
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title">人员职称管理</h4>
		</header>
		<div class="content">

<form id="orgGridForm" name="orgGridForm" method='post' action="job-user-remove.do" class="m-form-blank">
