...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgtypeSearch" class="content content-inner">
		  ...
		  <form name="orgtypeForm" method="post" action="party-dim-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='party-dim-input.do'">新建</button>
  ...
  <form id="orgTypeGridForm" name="orgTypeGridForm" method='post' action="party-dim-remove.do" class="m-form-blank">
    <table id="orgTypeGrid" class="m-table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>${item.priority}</td>
          <td>
            <a href="party-dim-input.do?id=${item.id}"><spring:message code="core.list.edit" text="编辑"/></a>
          </td>
        </tr>
        </c:forEach>
      </tbody>
