...
var config = {
	...
	exportUrl: 'party-dim-root-export.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgtypeSearch" class="content content-inner">
		  ...
		  <form name="orgtypeForm" method="post" action="party-dim-root.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='party-dim-root-input.do'">新建</button>
  ...
  <form id="orgTypeGridForm" name="orgTypeGridForm" method='post' action="party-dim-root-remove.do" class="m-form-blank">
    <table id="orgTypeGrid" class="m-table table-hover">
      <thead>
        <tr>
          ...
          <th class="sorting" name="dim">维度</th>
          <th class="sorting" name="entity">组织</th>
          <th width="50">&nbsp;</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td>${item.partyEntity.name}</td>
          <td>
            <a href="party-dim-root-input.do?id=${item.id}"><spring:message code="core.list.edit" text="编辑"/></a>
          </td>
        </tr>
        </c:forEach>
      </tbody>
