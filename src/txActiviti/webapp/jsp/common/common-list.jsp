    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="userSearch" class="content content-inner">
		  ...
		  <form name="userForm" method="post" action="common-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='common-input.do'">新建</button>
...
<form id="userGridForm" name="userGridForm" method='post' action="common-remove.do" class="m-form-blank">
  <table id="userGrid" class="m-table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.ref}</td>
        <td>
          <a href="common-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
